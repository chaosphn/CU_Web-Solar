...
export class InvertersComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  async init() {
    // this.groupConfig = await this.httpService.getConfig('assets/inverters/tag-group.json');
    console.log(this.siteName)
    const req: string[] = await this.httpService.getConfig('assets/inverters/inv.tag-req['+this.siteName.id+'].json');
