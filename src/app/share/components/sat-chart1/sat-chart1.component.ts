...
@Component({
  selector: 'app-sat-chart1',
  templateUrl: './sat-chart1.component.html',
  styleUrls: ['./sat-chart1.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SatChart1Component implements OnInit, OnDestroy, OnChanges {
  ...
  setPositionTooltip(labelWidth, labelHeight, point) {
    ...
    const plotWidth = this.chartE11.nativeElement.clientWidth;
    ...
    const chart = new Chart({
      ...
      tooltip: {
        ...
        formatter: function () {
          ...
          const hourFormat = (dateTime.getHours());
      ...
      plotOptions: _config.getPlotOption1()
    });
    this.chart = chart;
