...
@Component({
  selector: 'app-sat-chart3',
  templateUrl: './sat-chart3.component.html',
  styleUrls: ['./sat-chart3.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SatChart3Component implements OnInit, OnDestroy, OnChanges {
  ...
  setPositionTooltip(labelWidth, labelHeight, point) {
    ...
    const plotWidth = this.chartE3.nativeElement.clientWidth;
